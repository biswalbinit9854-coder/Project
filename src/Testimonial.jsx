...
function Testimonials() {
  return (
    <section
      id="testimonial"
      className="bg-[#F8F3EC] py-12 md:py-16 px-4"
    >
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow transition-all duration-300 hover:scale-105">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold">PETER</h2>
        ...
        <div className="bg-white p-6 rounded-2xl shadow transition-all duration-300 hover:scale-105">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold">ALLY</h2>
              <p className="text-yellow-500 text-lg">★★★★★</p>
            </div>
          </div>
        ...
        <div className="bg-white p-6 rounded-2xl shadow transition-all duration-300 hover:scale-105">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h2 className="text-xl md:text-2xl font-bold">RICHARD</h2>
              <p className="text-yellow-500 text-lg">★★★★★</p>
            </div>
          </div>
